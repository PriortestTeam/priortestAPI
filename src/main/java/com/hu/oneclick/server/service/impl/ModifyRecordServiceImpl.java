...
public class ModifyRecordServiceImpl implements ModifyRecordService {
    ...
    private final static Logger logger = LoggerFactory.getLogger(ModifyRecordServiceImpl.class);

    private final ModifyRecordDao modifyRecordDao;

    private final JwtUserServiceImpl jwtUserService;

    public ModifyRecordServiceImpl(ModifyRecordDao modifyRecordDao, JwtUserServiceImpl jwtUserService) {
    ...
    public Resp<List<ModifyRecord>> queryList(ModifyRecord modifyRecord) {
        try {
            ...
            List<ModifyRecord> select = modifyRecordDao.select(modifyRecord);
