...
public class TestCaseDataCaseDto {
    ...
    public void setTestPlanInput(String testPlanInput) {
        this.testPlanInput = testPlanInput;
    }

    public void setTestcaseExpand(String testcaseExpand) {
        // 如果有对应字段，设置值
        // this.testcaseExpand = testcaseExpand;
    }
