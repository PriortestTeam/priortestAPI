...
public class DefectDensityResponseDto {
    ...
    public static class StatisticsData {
        @Schema(description = "独立测试用例数", example = "50")
        private Integer uniqueTestCases;
        
        @Schema(description = "总执行次数", example = "120")
        private Integer totalExecutions;
        
        @Schema(description = "测试周期数", example = "3")
        private Integer totalCycles;
        
        @Schema(description = "独立缺陷数", example = "8")
        private Integer uniqueDefects;
        
        @Schema(description = "环境特定缺陷数", example = "5")
        private Integer environmentSpecificDefects;
        
        @Schema(description = "缺陷实例总数", example = "13")
        private Integer totalDefectInstances;
        
        @Schema(description = "发现缺陷的环境数", example = "3")
        private Integer environmentsWithDefects;
        
        @Schema(description = "总测试环境数", example = "3")
        private Integer totalEnvironments;
        
        @Schema(description = "环境覆盖率(%)", example = "100.0")
