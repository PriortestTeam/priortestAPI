...
public class VersionEscapeAnalysisResponseDto {
    ...
    public static class EscapeRateStats {
        ...
        private BigDecimal testEffectiveness;
        
        @Schema(description = "质量等级（优秀/良好/一般/需改进）")
    ...
    public static class DiscoveryTimingAnalysis {
        ...
        private Integer inVersionFound;
        
        @Schema(description = "发布前发现的缺陷数")
        private Integer preReleaseFound;
        
        @Schema(description = "发布后发现的缺陷数")
        private Integer postReleaseFound;
        
        @Schema(description = "发布后逃逸率（%）")
        private BigDecimal postReleaseEscapeRate;
        
        @Schema(description = "发现时机分布")
        private List<TimingDistribution> timingDistribution;
    }
    ...
    public static class QualityAssessment {
        @Schema(description = "整体质量评级")
        private String overallQualityGrade;
        ...
        private ComparisonBenchmark benchmark;
    }
