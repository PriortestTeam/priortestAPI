...
public class GlobalExceptionHandler {
    ...
    public Resp<String> handleConstraintViolationException(Exception e) {
        ...
        if (!ObjectUtils.isEmpty(allErrors)) {
            return new Resp.Builder<String>().buildResult(SysConstantEnum.PARAM_EMPTY.getCode(),allErrors.get(0).getDefaultMessage());
        }
        return new Resp.Builder<String>().buildResult(SysConstantEnum.SYS_ERROR.getValue());
    }
